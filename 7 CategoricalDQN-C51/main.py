...
from C51 import C51Agent as Agent
...
if __name__ == "__main__":
    ...
    train_rewards = train_dqn(env, agent, num_episodes=500, max_steps=400)
    ...
    plot_rewards(test_rewards, title="C51DQN Testing rewards")
    env.close()
