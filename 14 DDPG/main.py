...
from DDPG import DDPGAgent, Actor, Critic
...
def train_agent(env, agent, num_episodes=500, max_steps=1000):
    ...
    for episode in range(num_episodes):
        ...
        while not done and not truncated and steps < max_steps:
            ...
            scaled_action = action * env.action_space.high[0]  # 适配环境动作范围
...
def load_model(path_actor, path_critic, input_dim, output_dim, hidden_dim=[400, 300]):
...
def main():
    ...
    save_model(agent, "models/ddpg_actor.pth", "models/ddpg_critic.pth")
